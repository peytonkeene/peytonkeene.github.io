...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO expenses (description, date, amount) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ssd', $description, $date, $amount);

    if ($stmt->execute()) {
        header("Location: expense_manager.php?success=Expense added successfully");
        exit();
    } else {
...
<head>
    ...
    <title>Add Expense - MedNarrate</title>
